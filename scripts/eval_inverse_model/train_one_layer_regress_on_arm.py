...
def main():
	...
	with tf.Session() as sess:
		...
		train_obs, train_next_obs, train_action, train_joint = inputs(train_set_names, obs_shape, joint_pos_index=ARM_POS_INDEX[args.env_name], train=True)
		val_obs, val_next_obs, val_action, val_joint = inputs(val_set_names, obs_shape, joint_pos_index=ARM_POS_INDEX[args.env_name], train=False)
