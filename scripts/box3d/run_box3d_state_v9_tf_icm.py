...
for seed in seeds:
    mdp = TfEnv(normalize(env=GymEnv('Box3dReach-v9',record_video=False, \
    ...
    algorithm = ICM(
        mdp,
        algo,
        "/data0/dianchen/box3d/trpo_box3d_state_v9_tf_icm_%d"%seed,
    ...
    run_experiment_lite(
        algorithm.train(),
        exp_prefix='trpo_box3d_state_v9_tf_icm',
        n_parallel=1,
        snapshot_mode="gap",
        snapshot_gap=100,
        seed=seed,
