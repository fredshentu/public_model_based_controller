...
for seed in seeds:
    env = TfEnv(normalize(env=GymEnv('Box3dReachPixel-v7',record_video=False, \
    ...
    icm = ICM(
        env,
        idle,
        '/home/fred/box3d/trpo_box3d_pixel_v7_tf_idle_normalize_%d'%seed,
        feature_dim=256,
        forward_weight=0.2,
        inverse_tanh=True,
    ...
    run_experiment_lite(
        icm.train(),
        exp_prefix='trpo_box3d_pixel_v7_tf_idle_normalize',
        n_parallel=1,
        snapshot_mode="gap",
        snapshot_gap=200,
        seed=seed,
