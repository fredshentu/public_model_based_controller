...
for seed in seeds:
    mdp = TfEnv(normalize(env=GymEnv('Box3dReach-v18',record_video=False, \
    ...
    algorithm = ICM(
        mdp,
        idle,
        "/home/fred/tfboard_path/trpo_box3d_state_v18_tf_icm_idle_%d"%seed,
    ...
    run_experiment_lite(
        algorithm.train(),
        exp_prefix='trpo_box3d_state_v18_tf_icm_idle',
        n_parallel=8,
        snapshot_mode="gap",
        snapshot_gap=200,
        seed=seed,
